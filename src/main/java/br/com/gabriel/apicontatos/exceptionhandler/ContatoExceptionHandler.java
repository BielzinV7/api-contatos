package br.com.gabriel.apicontatos.exceptionhandler;
...
public class ContatoExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        String mensagemUsuario = messageSource.getMessage("atributo.nao-valido",null,LocaleContextHolder.getLocale());
